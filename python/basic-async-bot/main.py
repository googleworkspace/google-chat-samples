...
"""
Chat bot that responds to events and messages from a room asynchronously.
"""
...
def home_post():
    ...
    All requests sent to this endpoint from Chat are POST
    requests.
    """
...
def send_async_response(response, space_name):
    """Sends a response back to the Chat room asynchronously.

    Args:
      response: the response payload
      space_name: The URL of the Chat room
