...
/**
 * A simple text-only voting Chat App in Google Apps Script
 ...
 * @return {object} actual JSON payload to return to Chat App
 ...
 * vote when any MESSAGE events are received in Chat App.
 * @param {Event} e The Chat event
 * @return {object} JSON payload for new vote card
 * @see https://developers.google.com/chat/how-tos/apps-script#apps_script_bot_concepts
